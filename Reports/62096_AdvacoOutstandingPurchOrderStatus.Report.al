report 62096 "AdvOutstandingPOStatus"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/62096_AdvacoOutstandingPurchOrderStatus.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'Advaco Outstanding Purch.Order Status';
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            dataitem("Purchase Line"; "Purchase Line")
            {
                ...
                column(ackbox; ackbox)
                {

                }
                column(PurchHeaderQualityClause; PurchaseHeader."Quality Clause")
                {
                ...
                column(PLineCode; "purchase line"."code")
                {
                ...
                begin
                    ...
                    CASE OrderACKFilter OF
                        1:
                            BEGIN
                                IF NOT PurchaseHeader."Order Acknowledgement" THEN CurrReport.SKIP;
                                AckBox := 'ACK';
                            END;

                        2:
                            BEGIN
                                IF PurchaseHeader."Order Acknowledgement" THEN CurrReport.SKIP;
                                AckBox := ' ';
                            END;

                        ELSE
                            IF PurchaseHeader."Order Acknowledgement" THEN
                                AckBox := 'ACK'
                            ELSE
                                AckBox := ' ';
            ...
            begin
                ...
                // HEF Added Code to check for Receiving Inpection
                RI := '';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(orderackfilter; orderackfilter)
                    {
                        ApplicationArea = all;
                        caption = 'Order ACK';
                    }
