report 50170 "Rep. Monthly Statement2"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/50170_Rep. Monthly Statement2.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Outside Sales Reps"; "Outside Sales Reps")
        {
            ...
            begin
                //FormatAddress.OutsideRep(RepAddress,"Outside Sales Reps"); ICE-MPC 09/04/20
                FormatAddress.FormatAddr(RepAddress, "Outside Sales Reps"."Rep Company", "Outside Sales Reps"."Rep Name", '', "Outside Sales Reps"."Rep Address 1", '', "Outside Sales Reps"."Rep City", "Outside Sales Reps"."Rep Zip", "Outside Sales Reps"."Rep State", '');
                ;
                    ...
                    repeat
                        ...
                        if not GLEntry.Open then begin
                            ...
                            if (DateClosed >= FromPeriod) and (DateClosed <= ThruPeriod) then begin
                                ...
                                //Inbound & Outbound Freight deduction Code
                ...
                //CurrReport.PageNo := 0
                //else
                //FirstTime := true; ICE-MPC 09/04/20
            end;
    ...
    begin
        //with AccountingPeriod do begin  ICE-MPC Removed deprecated with statement.
