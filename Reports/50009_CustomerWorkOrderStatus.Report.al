report 50009 "Customer Work Order Status Rpt"
{
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Work Order Detail"; "WorkOrderDetail")
        {
            ...
            RequestFilterFields = "Customer ID", "Customer Part No.", "Model No.";
            column(WORK_ORDER_STATUS_REPORT_; 'WORK ORDER STATUS REPORT')
            {
            }
