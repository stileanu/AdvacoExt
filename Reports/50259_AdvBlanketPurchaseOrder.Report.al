report 50259 "Advaco Blanket Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/50259_AdvBlanketPurchaseOrder.rdl';
    Caption = 'Advaco Blanket Purchase Order';
                        ...
                        begin
                            ...
                            if OnLineNumber = NumberOfLines then begin
                                ...
                                if "Purchase Header"."Tax Area Code" <> '' then begin
                                    ...
                                    ///--! Added TempSalesTaxAmtLine. qualifier to Reset()                                        
    ...
    var
        ...
        PurchOrderCaptionLbl: Label 'BLANKET ORDER';
