report 50902 "Assembly Order Advaco"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/50902_AssemblyOrder.rdl';
    Caption = 'Assembly Order Advaco';
        ...
        dataitem("Assembly Header"; "Assembly Header")
        {
            ...
            dataitem("Assembly Line"; "Assembly Line")
            {
                ...
                var
                    myInt: Integer;
                begin
                    if "Assembly Line".Type = "Assembly Line".Type::Item then begin
                        item.get("Assembly Line"."No.");
                        Shelfbin := item."Shelf No.";
                    end else
                        Shelfbin := '';
                end;
            }
