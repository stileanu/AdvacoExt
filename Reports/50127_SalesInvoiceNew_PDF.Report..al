report 50127 "Sales Invoice New - PDF"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/50127_SalesInvoiceNew_PDF.rdl';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DocumentDate; Format("Sales Invoice Header"."Document Date", 0, 4))
                    {
                    }
            ...
            begin
                ...
                "Sales Invoice Header".CalcFields("Amount Including VAT"); //ICE RSK 1/6/21
            end;
