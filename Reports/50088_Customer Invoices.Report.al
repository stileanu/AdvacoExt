report 50088 "Customer Invoices"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/50088_Customer Invoices.rdl';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            column(CUSTOMER_INVOICESCaption; CUSTOMER_INVOICESCaptionLbl)
            {
            }
            ...
            dataitem("Sales Invoice Header"; "Sales Invoice Header")
            {
                ...
                column(Sales_Invoice_Header_Sell_to_Customer_No_; "Sell-to Customer No.")
                {
                }
            ...
            trigger OnAfterGetRecord()
            begin
                FormatAddress.Customer(RepAddress, Customer);
                ...
                PeriodText := 'For the Period from ' + Format(FromPeriod, 0, 1) + ' to ' + Format(ThruPeriod, 0, 1);

                CalcFields("Invoice Amounts");
                ThisPeriodSales := "Invoice Amounts";

                /*if FirstTime then
                  CurrReport.PageNo := 0
                else
                  FirstTime := true; ICE-MPC 08/21/20 */
            end;
    ...
    var
        ...
        FirstTime: Boolean;
        PeriodText: Text[50];
        CUSTOMER_INVOICESCaptionLbl: Label 'CUSTOMER INVOICES';
