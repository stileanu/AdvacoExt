report 50222 "Advaco Purchase Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/50222_AdvPurchaseOrder.rdl';
    Caption = 'Advaco Purchase Order';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(confirmto; "purchase header"."buy-from contact")
                    {
                    ...
                    column(vendorfax; vendor."Fax No.")
                    {
                    ...
                    column(Shipvia; "purchase header"."shipping agent")
                    {

                    }
                    Column(ShippingAdvice; "purchase header"."shipping advice")
                    {
                    ...
                    column(qualityclause; qualityclause)
                    {
                        ...
                        begin
                            ...
                            if OnLineNumber = NumberOfLines then begin
                                ...
                                if "Purchase Header"."Tax Area Code" <> '' then begin
                                    ...
                                    ///--! Reset is cleaning filters on "Purchase Line", not on intended TempSalesTaxAmtLine record. 
                                    ///Reset;
            ...
            begin
                ...
                POLine.SETRANGE(POLine."Document No.", "Purchase header"."No.");
                IF POLine.FIND('-') THEN BEGIN
                    // 2019-10-20 Start
                    //  IF POLine."Blanket Order No." <> '' THEN
                    //    BlanketNo := POLine."Blanket Order No."
                    //  ELSE
                    //    BlanketNo := '';
                    BlanketNo := '';
                    REPEAT
                ...
                // 2013-10-17 Start
                QualityClause := "Purchase Header"."Quality Clause" + ' as described in "Quality Clauses for Purchase Orders"';
                // 2013-10-17 End


                IF BlanketNo = '' THEN BEGIN
                    POL1 := 'Purchase Order Number:';
                    POL2 := 'Purchase Order Date:';
                    //POL3 := 'Page:';
                    POF1 := "Purchase Header"."No.";
                    POF5 := "Purchase Header"."Order Date";
                    //POF3 := CurrReport.PAGENO;
                END ELSE BEGIN
                    POL1 := 'Release Number:';
                    POL2 := 'Blanket Order Number:';
                    POL3 := 'Purchase Order Date:';
                    //POL4 := 'Page:';
                    POF1 := "Purchase Header"."No.";
                    POF2 := BlanketNo;
                    POF6 := "Purchase Header"."Order Date";
                    //POF4 := CurrReport.PAGENO;
                END;
            ...
            trigger OnPreDataItem()
            begin
                PrintCompany := true;  //ICE RSK 12/13/20
                if PrintCompany then
    ...
    begin
        ...
        //POFilter := "Purchase Header".GETFILTER("No.");
        //POLine2.SETRANGE(POLine2."Document Type", "Purchase Header"."Document Type");
        //POLine2.SETFILTER(POLine2."Document No.", POFilter);

        ///REPORT.RUN(50060, FALSE, FALSE, POLine2);
    end;
