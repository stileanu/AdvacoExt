report 62180 "AdvICECheck(Stub/Check/Stub)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/62180_ADVICE Check (Stub_Check_Stub).rdl';
    Caption = 'Advaco Check (Stub/Check/Stub)';
    ...
    dataset
    {
        ...
        "Gen. Journal Line")
        {
            ...
            column(banknamebankno; bankacc2.name + '/' + bankacc2."Bank Account No.")
            {
            ...
            "Integer")
            {
                ...
                "Integer")
                {
                    ...
                    column(Stub2PostingDesc_1_;
                    Stub2PostingDesc[1])
                    {
                    }
                    column(Stub2PostingDesc_2_;
                    Stub2PostingDesc[2])
                    {
                    }
                    column(Stub2PostingDesc_4_;
                    Stub2PostingDesc[4])
                    {
                    }
                    column(Stub2PostingDesc_3_;
                    Stub2PostingDesc[3])
                    {
                    }
                    column(Stub2PostingDesc_8_;
                    Stub2PostingDesc[8])
                    {
                    }
                    column(Stub2PostingDesc_7_;
                    Stub2PostingDesc[7])
                    {
                    }
                    column(Stub2PostingDesc_6_;
                    Stub2PostingDesc[6])
                    {
                    }
                    column(Stub2PostingDesc_5_;
                    Stub2PostingDesc[5])
                    {
                    }
                    column(Stub2PostingDesc_10_;
                    Stub2PostingDesc[10])
                    {
                    }
                    column(Stub2PostingDesc_9_;
                    Stub2PostingDesc[9])
                    {
                    }
                    ...
                    column(CheckDateText_Control1020013;
                    CheckDateText)
                    {
                    }
                    column(CheckNoText_Control1020014;
                    CheckNoText)
                    {
                    }
                    ...
                    column(Account_No_; accountnotext)
                    {
                ...
                begin
                    ...
                    if not TestPrint then
                        ...
                        CheckNoText := Text011;
                    //ICE MICR Check layout
                    MICRValue := 'C' + Checknotext + 'C A' + BankAcc2."Transit No." + 'A ' + BankAcc2."Bank Account No." + 'C';
                    Stub2LineNo := 0;
                    Clear(Stub2DocNo);
                    Clear(Stub2DocDate);
            ...
            trigger OnAfterGetRecord()
            begin
                clear(accountnotext); //ICE RSK 2/5/21
                    ...
                    case BalancingType of
                        ...
                        BalancingType::Customer:
                            begin
                                ...
                                AccountNoText := 'Customer: ' + cust."no.";
                        ...
                        BalancingType::Vendor:
                            begin
                                ...
                                Accountnotext := 'Vendor: ' + format(vend."no.");
    ...
    var
        ...
        MICRValue: Text[100]; //ICE DFP 04/03/20 - add field for MICR encoding
        accountnotext: text[150]; //ICE RSK 2/5/21
